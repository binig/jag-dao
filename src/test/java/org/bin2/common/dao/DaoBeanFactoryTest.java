...
public class DaoBeanFactoryTest {
	...
	public void testTargetDetect() throws Exception {
		...
		final Dao<BigDecimal, Long> dao = (Dao<BigDecimal, Long>) this.daoBeanFactory
				.getObject();
		assert BigDecimal.ONE == dao.load(id);
	}
	...
	void testBaseBeanFactory() {
		...
		assert this.daoBeanFactory.getDao() == TestDao.class;
		assert this.daoBeanFactory.isSingleton() == false;
		assert this.daoBeanFactory.getSessionFactory() == this.sessionFactory;
		this.daoBeanFactory.setSingleton(true);
		assert this.daoBeanFactory.isSingleton();
		assert this.daoBeanFactory.getObjectType() == TestDao.class;
	}
	...
	public void testToString() throws Exception {
		...
		final TestDao dao = (TestDao) this.daoBeanFactory.getObject();
		assert dao.toString().equals(TestDao.class.getName());
	}
